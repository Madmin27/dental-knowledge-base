...
test('HTTP preview serves only allowlisted assets and rejects writes and file disclosure',async t=>{
  ...
  for(const path of ['/viewer-runtime.js','/studio.css','/studio.js','/favicon.svg','/anatomy','/anatomy.js','/anatomy.css','/vendor/RoomEnvironment.js','/models/z-anatomy/neurovascular.json','/models/z-anatomy/neurovascular.bin','/models/z-anatomy/dentition.json','/models/z-anatomy/dentition.bin','/models/z-anatomy/ATTRIBUTION.txt','/models/z-anatomy/UPSTREAM-NOTICE.txt','/models/z-anatomy/CC-BY-SA-4.0.txt','/api/scenarios','/app.js','/style.css','/overview','/atlas.js','/atlas.css','/atlas-geometry.js','/vendor/three.module.js','/vendor/three.core.js','/vendor/OrbitControls.js','/vendor/THREE-LICENSE.txt']) assert.equal((await fetch(base+path)).status,200);
