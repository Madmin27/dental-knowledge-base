...
| P0 | Self-hosted academic coordination | ADR0007 / GOV-001–006: accounts, scoped authority, moderator desk, discussions, dissent, frozen-panel votes, reasoned decisions and appeals | All academic records stay on our server. GitHub code only. Start expert intake pilot after GOV-002; academic publication waits for eligibility, voting and release gates. |
